...
class Home extends BaseController
{
    ...
    public function KirimDonasi()
    {
        if ($this->validate([
            'bukti' => [
                ...
                'rules'     => 'uploaded[bukti]|max_size[bukti,2500]|mime_in[bukti,image/png,image/jpg,image/jpeg]',
                'errors'    => [
                    'uploaded'  => '{field} Belum Dipilih !',
                    'max_size'  => '{field} Max 2500 KB !',
    ...
    public function Lokasi()
    {
        $data = [
            'judul' => 'Lokasi',
            'page' => 'front-end/v_lokasi',
            'lokasi'    => $this->ModelHome->Lokasi(),
        ];
        return view('v_template', $data);
    }
}
