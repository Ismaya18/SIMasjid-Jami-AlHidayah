    ...
    <div id="carouselExampleCaptions" class="carousel slide" data-ride="carousel">
        ...
        <div class="carousel-inner">
            <div class="carousel-item active">
                <img src="<?= base_url('slider/Masjid3.jpg/' ) ?>" class="d-block w-100 img-fluid" alt="...">
            ...
            <div class="carousel-item">
                <img src="<?= base_url('slider/Masjid2.jpg/' ) ?>" class="d-block w-100 img-fluid" alt="...">
                <div class="carousel-caption d-none d-md-block">
            ...
            <div class="carousel-item">
                <img src="<?= base_url('slider/Masjid1.jpg/' ) ?>" class="d-block w-100 img-fluid" alt="...">
                <div class="carousel-caption d-none d-md-block">
...
<div class="col-lg-2">
    <div class="card card-outline card-primary">
        <div class="card-header">
            <h3 class="card-title text-primary"><b><?= $waktu['data']['lokasi'] ?></b></h3>
        </div>
        <!-- /.card-header -->
        <div class="card-body p-2">
            <ul class="products-list product-list-in-card pl-2 pr-2">
                <li class="item">
                    ...
                    <div class="product-info">
                        <a class="product-title">Imsak</a>
                        <span class="product-description">
                            <?= $waktu['data']['jadwal']['imsak'] ?>
                        </span>
                    </div>
                </li>
            ...
            <div class="text-center">
                <b class="text-primary"><?= $waktu['data']['jadwal']['tanggal'] ?></b>
            </div>
        </div>
        <!-- /.card-body -->
    </div>
        ...
        <div class="col-md-6">
            <div class="info-box mb-3">
                ...
                <div class="info-box-content">
                    ...
                    <span class="info-box-number">Rp. <?= number_format($saldo_s, 0) ?></span>
                </div>
                <!-- /.info-box-content -->
            </div>
            <!-- /.info-box -->
