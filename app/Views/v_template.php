...
<body class="hold-transition layout-top-nav">
    ...
    <div class="wrapper">
        ...
        <nav class="main-header navbar navbar-expand-md navbar-light navbar-white">
            <div class="container">
                <a href="<?= base_url('') ?>" class="navbar-brand">
                    <i class="fas fa-mosque text-blue fa-2x"></i><b> <?= $web['nama_masjid'] ?></b>
                </a>
                ...
                <ul class="order-1 order-md-3 navbar-nav navbar-no-expand ml-auto">
                    ...
                    <div class="collapse navbar-collapse order-3" id="navbarCollapse">
                        ...
                        <ul class="navbar-nav">
                            ...
                            <li class="nav-item">
                                <a href="<?= base_url('Home/Lokasi') ?>" class="nav-link">Lokasi</a>
                            </li>
                            <li class="nav-item">
                    ...
                    <div class="row mb-2">
                        ...
                        <div class="col-sm-6">
                            <ol class="breadcrumb float-sm-right">
                                <li class="breadcrumb-item"><a>SIMasjid</a></li>
                                <li class="breadcrumb-item"><a><?= $judul ?></a></li>
                            </ol>
                        </div><!-- /.col -->
                    </div><!-- /.row -->
                </div><!-- /.container-fluid -->
        ...
        <footer class="main-footer text-center">
            <!-- Default to the left -->
            <strong>Copyright &copy; <?= date('Y') ?> <a href=""><?= $web['nama_masjid'] ?></a>.</strong> <?= $web['alamat'] ?>
        </footer>
    </div>
    <!-- ./wrapper -->
