<div class="col-md-12">
    ...
    <div class="alert alert-primary alert-dismissible">
        <h5><i class="fas fa-money-bill-wave"></i> Total Pemasukan Kas Sosial</h5>
    ...
    <div class="modal fade" id="modal-delete<?= $value['id_kas_sosial'] ?>">
        <div class="modal-dialog">
            <div class="modal-content">
                ...
                <div class="modal-footer justify-content-between">
                    <button type="button" class="btn btn-outline-light" data-dismiss="modal">Tutup</button>
                    <a href="<?= base_url('KasSosial/DeleteKasMasuk/' . $value['id_kas_sosial']) ?>" class="btn btn-primary">Hapus</a>
                </div>
            </div>
            <!-- /.modal-content -->
        </div>
